# Reaper (pre-floor snapshot)

Frozen copy of `2026-04-19-reaper` *before* the Step 12.1 floor-rule
edit on 2026-04-20. Kept solely as the head-to-head opponent for the
bench run that justified the edit. See the sibling
`2026-04-19-reaper/` for the current Reaper weights and
...
Do not evolve this profile; if the live Reaper ever needs another
